...
export function ResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // ✅ fetch-based helper returns data directly
      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-sm p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-teal hover:bg-teal/90 disabled:opacity-60 text-white font-medium py-3 rounded-lg flex justify-center items-center gap-2 mt-6"
          >
