  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const res = await api.post(
        `/projects/${id}/assets?type=Deliverable`,
        formData,
        {
          ...
          <div className="flex justify-between items-start">
            <div>
              <h2 className="mb-2 text-2xl font-bold text-white">
                {project?.Request?.Category?.name || "Project"} Request
              </h2>
      ...
      <div className="max-w-7xl mx-auto p-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-[#0D1B2A] font-semibold">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-[#2EC4B6] transition-colors relative">
                {isUploading ? (
                  <div className="flex flex-col items-center">
                    <Loader2
                      className="animate-spin text-[#2EC4B6] mb-2"
                      size={32}
                    />
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <h3 className="mb-4 text-[#0D1B2A] font-semibold">
                Client Assets
              </h3>
              {clientAssets.length === 0 ? (
                <p className="text-sm text-gray-500 italic">
                  No assets uploaded by client yet.
                </p>
              ) : (
          ...
          <div className="space-y-6">
            {/* Progress Preview */}
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <h4 className="mb-6 text-[#0D1B2A] text-center font-semibold">
                Current Progress
              </h4>
            ...
            <div className="bg-gradient-to-br from-[#2EC4B6] to-[#26a599] rounded-xl p-6 shadow-lg text-white">
              ...
              {ecd && (
                <p className="text-sm text-white mt-2">
                  {Math.ceil(
                    (new Date(ecd).getTime() - new Date().getTime()) /
                      (1000 * 60 * 60 * 24)
                  )}{" "}
                  days remaining
                </p>
            ...
            {/* Project Stats */}
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <h4 className="mb-4 text-[#0D1B2A] font-semibold">
                Project Stats
              </h4>
            ...
            <div className="bg-gradient-to-br from-[#0D1B2A] to-[#1B2838] rounded-xl p-6 shadow-lg text-white border border-gray-700">
              ...
              {showVault ? (
                <div className="bg-black/30 p-3 rounded mb-4 break-all">
                  <p className="text-sm font-mono text-[#2EC4B6] whitespace-pre-wrap">
                    {vaultData || "No credentials found."}
                  </p>
                </div>
              ) : (
