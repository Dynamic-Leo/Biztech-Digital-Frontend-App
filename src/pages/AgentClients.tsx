...
import { Mail, Building, TrendingUp, ExternalLink } from 'lucide-react';
        ...
        <div className="p-4 sm:p-6 lg:p-8 max-w-full overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
              ...
              <p className="text-3xl font-semibold text-[#F39C12]">{clients.reduce((sum, c) => sum + c.activeProjects, 0)}</p>
            </div>
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
              ...
              <div key={client.id} className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="grid grid-cols-3 gap-4 py-4 border-t border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-[#3498DB]">{client.totalRevenue}</p>
                  </div>
                </div>

                <button
                  onClick={() => navigate(`/agent/client-details/${client.id}`)}
